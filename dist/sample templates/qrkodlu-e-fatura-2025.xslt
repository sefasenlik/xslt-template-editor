...
<title>Florit Web Hizmetleri e-Faturanız</title>
...
<div class="ph empty ph2">
        <xsl:text disable-output-escaping="yes">
                <![CDATA[<strong>TEL:</strong> +90 555 249 9439 (MUHAMMET ŞENLİK)<br/><strong>E-POSTA:</strong> info@florit.net.tr<br/><strong>WEB:</strong> florit.net.tr
]]>
        </xsl:text>
</div>
...
"aracikurumvkn":"<xsl:value-of select="//n1:Invoice/cac:TaxRepresentativeParty/cac:PartyIdentification/cbc:ID[@schemeID = 'ARACIKURUMVKN']"/>",
...
"odenecek":"<xsl:value-of select="n1:Invoice/cac:LegalMonetaryTotal/cbc:PayableAmount"/>"}
                   ...
                   <script type="text/javascript">var qrcode = new QRCode(document.getElementById("qrcode"), {width : 140,height : 140,correctLevel : QRCode.CorrectLevel.M});function makeCode (msg) {var elText = document.getElementById("text");qrcode.makeCode(msg);}makeCode(document.getElementById("qrvalue").innerHTML);</script>
            </div>
</div>
...
<xsl:if test="//n1:Invoice/cac:PricingExchangeRate/cbc:CalculationRate">
	...
	<tr>
			...
			<td>
					<xsl:value-of
	select="format-number(//n1:Invoice/cac:PricingExchangeRate/cbc:CalculationRate, '###.##0,######', 'european')"/>
					<span>
							<xsl:text> TL</xsl:text>
					</span>
			</td>
			...
			<tr>
					...
					<xsl:choose>
							...
							<xsl:when test="//n1:Invoice/cac:Delivery/cac:Shipment/cac:GoodsItem/cbc:DeclaredForCarriageValueAmount">
											...
											<xsl:value-of
													select="format-number(//n1:Invoice/cac:Delivery/cac:Shipment/cac:GoodsItem/cbc:DeclaredForCarriageValueAmount * //n1:Invoice/cac:PricingExchangeRate/cbc:CalculationRate, '###.##0,00', 'european')"/>
													<span>
															<xsl:text> TL</xsl:text>
													</span>
							...
							<xsl:when test="//n1:Invoice/cac:Delivery/cac:Shipment/cbc:DeclaredForCarriageValueAmount">
											...
											<xsl:value-of
													select="format-number(//n1:Invoice/cac:Delivery/cac:Shipment/cbc:DeclaredForCarriageValueAmount * //n1:Invoice/cac:PricingExchangeRate/cbc:CalculationRate, '###.##0,00', 'european')"/>
													<span>
															<xsl:text> TL</xsl:text>
													</span>
 ...
 <tr>
		...
		<xsl:choose>
				...
				<xsl:when test="//n1:Invoice/cac:Delivery/cac:Shipment/cac:GoodsItem/cbc:InsuranceValueAmount">
								...
								<xsl:value-of
										select="format-number(//n1:Invoice/cac:Delivery/cac:Shipment/cac:GoodsItem/cbc:InsuranceValueAmount * //n1:Invoice/cac:PricingExchangeRate/cbc:CalculationRate, '###.##0,00', 'european')"/>
										<span>
												<xsl:text> TL</xsl:text>
										</span>
				...
				<xsl:when test="//n1:Invoice/cac:Delivery/cac:Shipment/cbc:InsuranceValueAmount">
								...
								<xsl:value-of
										select="format-number(//n1:Invoice/cac:Delivery/cac:Shipment/cbc:InsuranceValueAmount * //n1:Invoice/cac:PricingExchangeRate/cbc:CalculationRate, '###.##0,00', 'european')"/>
										<span>
												<xsl:text> TL</xsl:text>
										</span>
...
<xsl:if test="//n1:Invoice/cac:LegalMonetaryTotal/cbc:AllowanceTotalAmount !=0">
		<tr>
				...
				<td>
						<xsl:value-of
select="format-number(//n1:Invoice/cac:LegalMonetaryTotal/cbc:AllowanceTotalAmount * //n1:Invoice/cac:PricingExchangeRate/cbc:CalculationRate, '###.##0,00', 'european')"/>
						<xsl:if
test="//n1:Invoice/cac:LegalMonetaryTotal/cbc:AllowanceTotalAmount/@currencyID">
			...
			<xsl:if test="//n1:Invoice/cac:LegalMonetaryTotal/cbc:ChargeTotalAmount !=0">
					<tr>
							...
							<td>
									<xsl:value-of
	select="format-number(//n1:Invoice/cac:LegalMonetaryTotal/cbc:ChargeTotalAmount  * //n1:Invoice/cac:PricingExchangeRate/cbc:CalculationRate, '###.##0,00', 'european')"/>
									<span>
											<xsl:text> TL</xsl:text>
									</span>
							</td>
...
<tr>
		...
		<td class="sumValue">
				<xsl:value-of
select="format-number(//n1:Invoice/cac:LegalMonetaryTotal/cbc:TaxExclusiveAmount * //n1:Invoice/cac:PricingExchangeRate/cbc:CalculationRate,  '###.##0,00', 'european')"/>
				<xsl:if
...
<tr>
		...
		<td class="sumValue">
				<xsl:value-of select="format-number(sum(n1:Invoice/cac:WithholdingTaxTotal/cac:TaxSubtotal/cbc:TaxableAmount[starts-with(../cac:TaxCategory/cac:TaxScheme/cbc:TaxTypeCode,'6') or (starts-with(./cac:TaxCategory/cac:TaxScheme/cbc:TaxTypeCode,'8'))]) * //n1:Invoice/cac:PricingExchangeRate/cbc:CalculationRate, '###.##0,00', 'european')"/>
				<span>
						<xsl:text> TL</xsl:text>
				</span>
		</td>
...
<xsl:if test="n1:Invoice/cac:WithholdingTaxTotal/cac:TaxSubtotal[starts-with(./cac:TaxCategory/cac:TaxScheme/cbc:TaxTypeCode,'4')]">
		<tr>
				...
				<td class="sumValue">
						<xsl:value-of select="format-number(sum(n1:Invoice/cac:InvoiceLine/cac:TaxTotal/cac:TaxSubtotal/cbc:TaxableAmount[../../../cac:WithholdingTaxTotal/cac:TaxSubtotal[starts-with(./cac:TaxCategory/cac:TaxScheme/cbc:TaxTypeCode,'4') and ../cac:TaxCategory/cac:TaxScheme/cbc:TaxTypeCode =0071]]) * //n1:Invoice/cac:PricingExchangeRate/cbc:CalculationRate, '###.##0,00', 'european')"/>
						<span>
								<xsl:text> TL</xsl:text>
						</span>
				</td>
...
<tr>
		...
		<td class="sumValue">
				<xsl:value-of select="format-number(sum(n1:Invoice/cac:WithholdingTaxTotal/cac:TaxSubtotal/cbc:TaxableAmount[starts-with(../cac:TaxCategory/cac:TaxScheme/cbc:TaxTypeCode,'4')]) * //n1:Invoice/cac:PricingExchangeRate/cbc:CalculationRate, '###.##0,00', 'european')"/>
				<span>
						<xsl:text> TL</xsl:text>
				</span>
		</td>
...
<xsl:for-each select="n1:Invoice/cac:WithholdingTaxTotal/cac:TaxSubtotal[starts-with(./cac:TaxCategory/cac:TaxScheme/cbc:TaxTypeCode,'4')]">
		<tr>
				<th>
						...
						<xsl:value-of select="./cac:TaxCategory/cac:TaxScheme/cbc:TaxTypeCode"/>) (TL):
				</th>
				<td class="sumValue">
						<xsl:value-of select="../cbc:TaxAmount * //n1:Invoice/cac:PricingExchangeRate/cbc:CalculationRate"/>
						<span>
								<xsl:text> TL</xsl:text>
						</span>
				</td>
...
<div class="ph empty ph11">
        <xsl:text disable-output-escaping="yes">
                <![CDATA[<strong>IBAN (TL)</strong>: TR61 0020 3000 0914 6672 0000 01<br/><strong>HESAP SAHİBİ:</strong> SEFA ŞENLİK<br/><strong>BANKA ADI:</strong> ALBARAKA TÜRK BANKASI / DENİZLİ SANAYİ ŞB.]]>
        </xsl:text>
</div>
